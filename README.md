...
Jupyter+R: [![Binder](http://mybinder.org/badge_logo.svg)](https://binder.mybinder.ovh/v2/gh/w201rdada/exhibits/master?filepath=index.ipynb)

RStudio: [![Binder](http://mybinder.org/badge_logo.svg)](https://binder.mybinder.ovh/v2/gh/w201rdada/exhibits/master?urlpath=rstudio)
...
- For the RStudio environment, we must add the following at the end of the URL: `?urlpath=rstudio`
  ...
  - Example: https://binder.mybinder.ovh/v2/gh/w201rdada/exhibits/master?urlpath=rstudio
...
name of the repository, placing instead a hyphen (the reason is that spaces are converted to `%20`).
  ...
  - Example: https://binder.mybinder.ovh/v2/gh/w201rdada/exhibits/master?urlpath=shiny/sampling-frame/
